...
export function AgentContactModal({ isOpen, onClose, agentName, agentId }: AgentContactModalProps) {
  ...
  const contactMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "El agente recibirá tu mensaje en breve.",
      });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-xl">Aplica por {agentName}</DialogTitle>
        </DialogHeader>
