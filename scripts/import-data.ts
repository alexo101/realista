  ...
  try {
    ...
    for (const agency of agenciesData) {
      ...
      await db.insert(agencies).values({
        ...
        agencyInfluenceNeighborhoods: Array.isArray(transformed.agency_influence_neighborhoods) ? transformed.agency_influence_neighborhoods : (transformed.agency_influence_neighborhoods ? [transformed.agency_influence_neighborhoods] : []),
        agencySupportedLanguages: Array.isArray(transformed.agency_supported_languages) ? transformed.agency_supported_languages : (transformed.agency_supported_languages ? [transformed.agency_supported_languages] : []),
    ...
    for (const agent of agentsData) {
      ...
      await db.insert(agents).values({
        ...
        createdAt: transformed.created_at || new Date(),
        city: transformed.city || 'Barcelona',
        influenceNeighborhoods: Array.isArray(transformed.influence_neighborhoods) ? transformed.influence_neighborhoods : (transformed.influence_neighborhoods ? [transformed.influence_neighborhoods] : null),
        yearsOfExperience: transformed.years_of_experience,
        languagesSpoken: Array.isArray(transformed.languages_spoken) ? transformed.languages_spoken : (transformed.languages_spoken ? [transformed.languages_spoken] : null),
    ...
    for (const property of propertiesData) {
      ...
      await db.insert(properties).values({
        ...
        features: Array.isArray(transformed.features) ? transformed.features : (transformed.features ? [transformed.features] : null),
        ...
        images: Array.isArray(transformed.images) ? transformed.images : (transformed.images ? [transformed.images] : null),
        imageUrls: Array.isArray(transformed.image_urls) ? transformed.image_urls : (transformed.image_urls ? [transformed.image_urls] : null),
